...
// src/Arcara.ts
var TIMEOUT_MS = 3e4;
var proto = import_node_http.default.ServerResponse.prototype;
...
var Arcara = class extends Layer {
  ...
  constructor() {
    super();
    this.server = import_node_http.default.createServer(this.handleRequest.bind(this));
  }
  /**
